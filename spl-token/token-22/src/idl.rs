...
pub struct ConfigureConfidentialTransferAccountArguments {
    pub confidential_transfer_discriminator: u8,
    pub decryptable_zero_balance: u8,
    #[serde(serialize_with = "crate::serialize_to_string")]
...
pub struct ConfidentialWithdrawArguments {
    ...
    pub amount: u64,
    pub decimals: u8,
    pub new_decryptable_available_balance: u8,
...
pub struct ConfidentialTransferArguments {
    pub confidential_transfer_discriminator: u8,
    pub new_source_decryptable_available_balance: u8,
    pub equality_proof_instruction_offset: i8,
...
pub struct InitializeConfidentialTransferFeeArguments {
    ...
    pub authority: u8,
    pub withdraw_withheld_authority_el_gamal_pubkey: u8,
}
#[derive(:: borsh :: BorshDeserialize, Debug, Serialize)]
...
impl Instruction {
    pub fn decode(data: &[u8], account_keys: &[String]) -> Result<Self, String> {
        ...
        match discriminator {
            ...
            [6u8] => {
                let mut rdr: &[u8] = rest;
                let authority_type: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| {
                    format!(
                        "Failed to deserialize {}: {}",
            ...
            [27u8] => {
                ...
                let authority: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| {
                        format!("Failed to deserialize {}: {}", stringify!(authority), e)
                    })?;
            ...
            [27u8] => {
                ...
                let decryptable_zero_balance: u8 =
                    <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr).map_err(|e| {
                        format!(
                            "Failed to deserialize {}: {}",
            ...
            [27u8] => {
                ...
                let new_decryptable_available_balance: u8 =
                    <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr).map_err(|e| {
                        format!(
                            "Failed to deserialize {}: {}",
            ...
            [27u8] => {
                ...
                let new_source_decryptable_available_balance: u8 =
                    <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr).map_err(|e| {
                        format!(
                            "Failed to deserialize {}: {}",
            ...
            [28u8] => {
                ...
                let state: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
            ...
            [33u8] => {
                ...
                let rate_authority: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| {
                    format!(
                        "Failed to deserialize {}: {}",
            ...
            [36u8] => {
                ...
                let program_id: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| {
                        format!("Failed to deserialize {}: {}", stringify!(program_id), e)
                    })?;
            ...
            [37u8] => {
                ...
                let withdraw_withheld_authority_el_gamal_pubkey: u8 =
                    <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr).map_err(|e| {
                        format!(
                            "Failed to deserialize {}: {}",
            ...
            [39u8] => {
                ...
                let metadata_address: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| {
                        format!(
                            "Failed to deserialize {}: {}",
            ...
            [40u8] => {
                ...
                let group_address: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| {
                        format!("Failed to deserialize {}: {}", stringify!(group_address), e)
                    })?;
            ...
            [41u8] => {
                ...
                let member_address: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| {
                    format!(
                        "Failed to deserialize {}: {}",
            ...
            [0u8] => {
                let mut rdr: &[u8] = rest;
                let name: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| format!("Failed to deserialize {}: {}", stringify!(name), e))?;
                let symbol: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| format!("Failed to deserialize {}: {}", stringify!(symbol), e))?;
                let uri: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
            ...
            [0u8] => {
                let mut rdr: &[u8] = rest;
                let field: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| format!("Failed to deserialize {}: {}", stringify!(field), e))?;
                let value: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
            ...
            [0u8] => {
                ...
                let key: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
            ...
            [0u8] => {
                let mut rdr: &[u8] = rest;
                let update_authority: u8 = <u8 as ::borsh::BorshDeserialize>::deserialize(&mut rdr)
                    .map_err(|e| {
                        format!(
                            "Failed to deserialize {}: {}",

...
pub fn prepare_input_accounts(instruction_type: String, accounts: &[String]) -> InputAccounts {
    ...
    match instruction_type.as_str() {
        ...
        "ClosePositionWithTokenExtensions" => {
            ...
            input_accounts.position_mint = get_account!(3);
            input_accounts.position_token_account = get_account!(4);
            input_accounts.token_program = get_account!(5); // token2022Program -> token_program
        }

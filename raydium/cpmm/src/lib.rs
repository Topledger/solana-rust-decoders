...
mod tests {
    ...
    #[test]
    fn test_raydium_cpmm_decode() {
        let sample_data = "66JafaVu7KMxSjJTzEMLxRQNKjo67bQR5";
        
        println!("Testing raydium CPMM decoder with sample data:");
    ...
    #[test]
    fn test_cpmm_with_accounts() {
        let sample_data = "66JafaVu7KMxSjJTzEMLxRQNKjo67bQR5";
        
        println!("Testing CPMM decode with specific accounts:");
        println!("Base58 input: {}", sample_data);
        ...
        // Provide meaningful account names for CPMM
        let accounts = vec![
            "authority".to_string(),
    ...
    #[test]
    fn test_cpmm_json_serialization() {
        println!("Testing CPMM JSON serialization:");

...
fn main() -> Result<()> {
    ...
    let out = quote! {
        ...
        pub mod typedefs {
            ...
            use serde::Serialize;
            serde_big_array::big_array! { BigArray; 60, 64, 51,128, 72, 256 /*, …other sizes…*/ }
            #typedefs_rs
        }
        ...
        pub mod ix_data {
            ...
            use crate::pubkey_serializer::pubkey_serde;
            use crate::pubkey_serializer::pubkey_serde_option;
            serde_big_array::big_array! { BigArray; 60, 64, 51, 72 , 128, 256/*, …other sizes…*/ }
            #(#args_structs)*
        }
